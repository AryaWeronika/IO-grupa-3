                            ...
                            <Steps>
                                    ...
                                    <div className="step step-1 active">
                                        <div className="form-group">
                                            ...
                                            <input type="text" minLength='5' required name="username" id="username" name="username" onChange={handleChange} />
                                             {
                                                errors.username && <h8>{errors.username}</h8>

                                        }
                                         
                                        <button type="submit" id="next" method="get" className="next-btn" onClick={next}><img className="strzalkaprawo" src={strzalkaprawo} withh={50} height={50} /></button>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="form-group">
                                        <p>Ile masz lat?</p>
                                        <input type="text" id="wiek" minLength='2' required name="wiek" onChange={handleChange} />
                                        {
                                            errors.wiek && <h8>{errors.wiek}</h8>
                                ...
                                <div className="form-group">
                                    <p>Podaj swój wzrost (cm)</p>
                                        <input type="text" id="wzrost" minLength='3' required name="wzrost" onChange={handleChange} />
                                        {
                                            errors.wzrost && <h8>{errors.wzrost}</h8>
                                ...
                                <div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" id="waga" minLength='2' required name="waga" onChange={handleChange} />
                                        {
                                            errors.waga && <h8>{errors.waga}</h8>
                                ...
                                <div>
                                    ...
                                    <button type="button" onClick={prev} className="previous-btn"><img className="strzalkalewo" src={strzalkalewo} withh={50} height={50} /></button>
                                    <button type="submit" onClick={next} className="submit-btn"><img className="wyslij" src={wyslij} width={70} height={50} /></button>
